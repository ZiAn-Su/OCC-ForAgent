...
export const UPSTREAM_LATEST_RELEASE_URL = 'https://api.github.com/repos/ZiAn-Su/OCC-ForAgent/releases/latest';
export const UPSTREAM_RELEASES_URL = 'https://github.com/ZiAn-Su/OCC-ForAgent/releases/latest';
